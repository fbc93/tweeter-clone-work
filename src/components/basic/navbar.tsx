...
const NavBar = () => {
  ...
  return (
    <nav className="text-white fixed z-100 bottom-0 left-0 w-full h-navbar backdrop-blur-sm bg-black/70">
      <ul className="flex justify-center w-container mx-auto h-full bg-gray items-top pt-3">
        <NavbarItem
          ...
          content="피드"
          activeStyle={router.pathname === "/" ? "text-yellow-400" : ""}
        />
        <NavbarItem
          link="/mylog"
          ...
          content="마이로그"
          activeStyle={router.pathname === "/mylog" ? "text-yellow-400" : ""}
        />
        <NavbarItem
          link="/tweet/write"
          ...
          content="글쓰기"
          activeStyle={router.pathname === "/tweet/write" ? "text-yellow-400" : ""}
        />
        <NavbarItem
          ...
          content="프로필"
          activeStyle={router.pathname === "/user/edit-profile" ? "text-yellow-400" : ""}
        />
        <NavbarItem
